...
| Release | Both repositories pass required automated checks | PARTIAL | The [pinned dashboard CI](https://github.com/s-hiraoku/agent-host-dashboard/actions/runs/31591117758) and the parent [host integrated CI](https://github.com/s-hiraoku/agent-host/actions/runs/31594311951) are green. This branch adds API contracts after that host run and requires its own green Node 22/23/24 and integrated-artifact CI before promotion. |

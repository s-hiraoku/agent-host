...
- Current local verification: 111 tests passed, `git diff --check` passed, and the 41-file integrated candidate built with SHA-256 `bf3aefc7adbe90ae22ebcc80a4659c5504dc97bd9a1732df96ca93ae5d41167c`. Its archive/release-manifest/SPDX checksums passed; the extracted archive installed with Node 24.14.0 and its stable launcher passed the pinned dashboard live conformance suite. The local default Node 26.0.0 was rejected before installation as required. CI evidence remains pending for this branch.
